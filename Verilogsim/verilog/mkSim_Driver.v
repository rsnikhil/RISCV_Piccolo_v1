...
//
// On Thu Jul  7 14:37:19 EDT 2016
//
//
// Ports:
// Name                         I/O  size props
...
module mkSim_Driver(CLK,
  ...
  reg [63 : 0] v__h43307, v__h43844, v__h43887, v__h43930;
  reg [31 : 0] b__h43597, v__h44818;
  reg [7 : 0] v__h503;
  wire [127 : 0] rg_end_cycle_50_MINUS_rg_start_cycle_51_52_MUL_10___d153;
  wire [63 : 0] c__h50753,
		cpi_x10__h50755,
		rg_end_cycle_50_MINUS_rg_start_cycle_51_52_MUL_ETC___d156,
		rg_end_cycle_50_MINUS_rg_start_cycle_51_52_MUL_ETC___d157,
		rg_end_instret_42_MINUS_rg_start_instret_43___d144,
		x__h43082,
		x__h44865,
		x__h46079;
  wire [31 : 0] x__h44868;
  wire abort_whas__0_AND_abort_wget__1_2_OR_state_mkF_ETC___d168,
       rg_addr_6_EQ_rg_exit_pc_4___d85,
       rg_addr_6_ULT_rg_max_addr_3___d77;
  ...
  assign CAN_FIRE_RL_action_l178c10 =
	     (x__h43082 == 64'd0 || fControlReq$FULL_N) &&
  ...
  assign CAN_FIRE_RL_action_l232c89 =
	     fControlReq$FULL_N && rg_addr_6_ULT_rg_max_addr_3___d77 &&
  ...
  assign CAN_FIRE_RL_action_l160c53 =
	     rg_end_instret_42_MINUS_rg_start_instret_43___d144 != 64'd0 &&
	     state_mkFSMstate == 5'd21 ;
  assign WILL_FIRE_RL_action_l160c53 = CAN_FIRE_RL_action_l160c53 ;

  // rule RL_fsm_start
  assign CAN_FIRE_RL_fsm_start =
	     abort_whas__0_AND_abort_wget__1_2_OR_state_mkF_ETC___d168 &&
	     start_reg ;
  ...
  assign MUX_fControlReq$enq_1__SEL_1 =
	     WILL_FIRE_RL_action_l178c10 && x__h43082 != 64'd0 ;
  ...
  assign MUX_fControlReq$enq_1__VAL_1 =
	     { 128'hAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA, x__h43082, 16'd10498 } ;
  assign MUX_fControlReq$enq_1__VAL_2 =
	     { 64'd0, x__h44865, rg_addr, 16'd2819 } ;
  assign MUX_fControlReq$enq_1__VAL_3 =
	     { 128'hAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA, x__h46079, 16'd10242 } ;
  ...
  // register rg_elf_file_loaded
  assign rg_elf_file_loaded$D_IN = b__h43597 != 32'd0 ;
  ...
  // remaining internal signals
  assign abort_whas__0_AND_abort_wget__1_2_OR_state_mkF_ETC___d168 =
	     (state_mkFSMstate == 5'd0 || state_mkFSMstate == 5'd23) &&
	     (!start_reg_1 || state_fired) ;
  assign c__h50753 = rg_end_cycle - rg_start_cycle ;
  assign cpi_x10__h50755 =
	     rg_end_cycle_50_MINUS_rg_start_cycle_51_52_MUL_10___d153[63:0] /
	     rg_end_instret_42_MINUS_rg_start_instret_43___d144 ;
  assign rg_addr_6_EQ_rg_exit_pc_4___d85 = rg_addr == rg_exit_pc ;
  assign rg_addr_6_ULT_rg_max_addr_3___d77 = rg_addr < rg_max_addr ;
  assign rg_end_cycle_50_MINUS_rg_start_cycle_51_52_MUL_10___d153 =
	     c__h50753 * 64'd10 ;
  assign rg_end_cycle_50_MINUS_rg_start_cycle_51_52_MUL_ETC___d156 =
	     cpi_x10__h50755 / 64'd10 ;
  assign rg_end_cycle_50_MINUS_rg_start_cycle_51_52_MUL_ETC___d157 =
	     cpi_x10__h50755 % 64'd10 ;
  assign rg_end_instret_42_MINUS_rg_start_instret_43___d144 =
	     rg_end_instret - rg_start_instret ;
  assign x__h43082 = $imported_c_getenv_u64("SIM_LOGDELAY") ;
  assign x__h44865 = { 32'd0, x__h44868 } ;
  assign x__h44868 =
	     rg_addr_6_EQ_rg_exit_pc_4___d85 ? 32'd1048691 : v__h44818 ;
  assign x__h46079 = $imported_c_getenv_u64("SIM_VERBOSITY") ;
  ...
  begin
    #0;
    if (RST_N != `BSV_RESET_VALUE)
      if (f_to_console$EMPTY_N) $imported_c_putchar(f_to_console$D_OUT);
    if (RST_N != `BSV_RESET_VALUE)
      if (f_from_console$FULL_N)
	begin
	  v__h503 = $imported_c_trygetchar;
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_action_l178c10 && x__h43082 != 64'd0)
	$display("INFO: Top_Sim_Standalone: setting logdelay = %0d from environment setting",
		 x__h43082);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_action_l201c10)
	begin
	  v__h43307 = $imported_bsv_mem_init(64'd0, 64'd2097152);
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_action_l207c10)
	begin
	  b__h43597 = $imported_bsv_mem_load_elf2(rg_p_state, 64'd32);
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_action_l216c13)
	begin
	  v__h43844 = $imported_bsv_mem_get_min_addr(rg_p_state);
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_action_l216c13)
	begin
	  v__h43887 = $imported_bsv_mem_get_max_addr(rg_p_state);
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_action_l216c13)
	begin
	  v__h43930 = $imported_bsv_mem_get_exit_pc(rg_p_state);
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
	...
	begin
	  v__h44818 = $imported_bsv_mem_read32(rg_p_state, 64'd0, rg_addr);
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_action_l232c89 && rg_addr_6_EQ_rg_exit_pc_4___d85)
	...
	$display("            cycles - instrs %0d",
		 ...
		 rg_end_instret_42_MINUS_rg_start_instret_43___d144);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_action_l248c10 && x__h46079 != 64'd0)
