...
//
// On Thu Jul  7 14:37:37 EDT 2016
//
//
// Ports:
// Name                         I/O  size props
...
module mkTop_Sim_Standalone(CLK,
  ...
  assign CAN_FIRE_RL_memCnx_ClientServerRequest =
	     mem$RDY_request_put && soc_top$RDY_to_raw_mem_request_get ;
  ...
  assign CAN_FIRE_RL_memCnx_ClientServerResponse =
	     mem$RDY_response_get && soc_top$RDY_to_raw_mem_response_put ;
  ...
  assign CAN_FIRE_RL_from_console_cnx_mkConnectionGetPut =
	     soc_top$RDY_from_console_put && sim_driver$RDY_from_console_get ;
  ...
  assign CAN_FIRE_RL_to_console_cnx_mkConnectionGetPut =
	     soc_top$RDY_to_console_get && sim_driver$RDY_to_console_put ;
